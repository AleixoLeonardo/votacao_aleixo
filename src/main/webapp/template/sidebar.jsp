...
<div class="bg-light border-right" id="sidebar-wrapper">
	...
	<div class="list-group list-group-flush">
		...
		%>
		<a href="./relatorio/relatorio_votacao.jsp"
			class="list-group-item list-group-item-action bg-light">Relatório
			de Votação</a>
		<%
			}
		...
		%>
		<a href="./voto/secao.jsp"
			class="list-group-item list-group-item-action bg-light">Seção</a>
		<%
			}
			}
		%>
